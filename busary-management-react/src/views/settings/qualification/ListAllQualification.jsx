...
const ListAllQualifications = () => {
    ...
    const fetchData = async (currentPage_, searchText_) => {
        setLoading(true);
        var url = `/api/v1/qualification?page=${currentPage_ - 1}&size=10&sort=qualificationName&searchText=${searchText_}`
        console.log("My URL");
        console.log(url);
        const apiCall = await http.get(url);
        if (apiCall.code === 200) {
            setQualificationList(apiCall.data.content);
            setLoading(false);
        } else {
                ...
                <CCardHeader>
                    ...
                    <CCardBody>
                        <div className='row mb-2'>
                              <div className='col-8'>There are <strong>{qualificationList.length}</strong> qualifications in the system</div>
                            <div className='col-4'>
                                <CInputGroup>
                                    <CFormInput
                                        type="text"
                                        ...
                                        value={searchText}
                                        feedbackInvalid="Enter qualification"
                                    />
...
export default ListAllQualifications
